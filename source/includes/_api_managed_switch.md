...
state          |  string            | State of the managed switch: "PROB" &#124; "REDY" &#124; "CTRL". See note below for explanation
bridges        |  list of strings   | List of bridge ESN's this managed switch was found on
...
available _bridges| list of strings | List of available bridge ESN's, i.e. bridges that this switch can be attched to
name           |  string            | Name of the switch


State of a managed switch is decoded as follows:  
REDY - Switch is idle and ready to control  
PROB - Switch is probing for the data behind ports like mac/voltage/enabled etc.  
CTRL - Switch is busy actively changing settings  
...
enabled        |  string            | "true" &#124; "false". Indicates whether the port is on or off. 
...
```shell
curl --request GET https://c001.eagleeyenetworks.com/g/managed_switch?guid=[GUID]   --cookie "auth_key=[AUTH_KEY]"
```
