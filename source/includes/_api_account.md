...
is_advanced_disabled           | int                  | Indicates whether the reseller has disabled advanced functionality (1) or not (0)                       | true     |
...
is_initial_user_not_admin    | int      	   | Indicates whether the initial user is NOT an admin (1) or not (0)
